...
export default function RegisterView() {
    ...
    const handleRegister = () =>{
        console.log('Desde HanldeRegister')
    }
    ...
    return (
        <>
            ...
            {/* Creacion de formulario con codigo HTML y Tailwind*/}
            <form 
            ...
            >
                <div className="grid grid-cols-1 space-y-3">
                    ...
                    <input
                        ...
                        })} /*Se encarga de validar que este campo este lleno, es otro tipo de validacion en el front end*/
                    />
            ...
            <nav className=' mt-7'> 
                ...
                <Link className='text-center text-white text-lg block' to="/auth/login"> ¿Ya tienes una cuenta creada? Inicia Sesión </Link>
            </nav>
        </>
    )
}